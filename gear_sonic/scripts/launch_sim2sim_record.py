...
Uses the unitree_ros ``g1_29dof`` rubber-hand suitcase scene with sim cameras (ego / wrist / global).
...
class Sim2SimRecordConfig:
    ...
    model_path: str = "/home/ubuntu/DATA4/zzb/chekpoint_suitcase/checkpoint-5000"
    """Path to the finetuned Isaac-GR00T checkpoint."""

    embodiment_tag: str = "unitree_g1_sonic_no_hand"
    """Embodiment tag (must match the checkpoint)."""
    ...
    """Also record left/right wrist camera mp4s."""
